...
add wave -noupdate -color grey -radix unsigned /top_tb/dut/pipeline_inst/pipeline_1/pipeline_unit_inst/*
add wave -noupdate -color violet -itemcolor violet -radix unsigned /top_tb/dut/pipeline_inst/pipeline_1/buffer_slots_inst/*
add wave -noupdate -color white -itemcolor white -radix unsigned /top_tb/dut/pipeline_inst/pipeline_1/stall_mgmt_inst/*
add wave -noupdate -color green -itemcolor green -radix unsigned /top_tb/dut/pipeline_inst/pipeline_2/pipeline_unit_inst/*
add wave -noupdate -color teal -itemcolor teal -radix unsigned /top_tb/dut/pipeline_inst/pipeline_2/buffer_slots_inst/*
add wave -noupdate -color lime -itemcolor lime -radix unsigned /top_tb/dut/pipeline_inst/pipeline_2/stall_mgmt_inst/*
